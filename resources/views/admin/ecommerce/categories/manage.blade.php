                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                <form class="form form-horizontal form-bordered">
                                    <div class="form-body">
                                        <h4 class="form-section">Manage Categories</h4>
                                        <div class="row">
                                        	<div class="col-md-10">
                            		            @if($total_records < 10)
                                        	...
                                        	<div class="col-md-1">
                                        		<a href="{{ route('add_categories') }}"><i class="ft-plus"></i> Add</a>
                                    		</div>
                                    		<div class="col-md-1" id="filter_button">
                                    			<a href="javascript::void(0);" id="add_filter"><i class="ft-filter"></i> Filter</a>
                                                <input type="hidden" id="search_url" value="{{ route('search_categories') }}">
                                    		</div>
                                    	</div>
        				                                    ...
        				                                    <td>
        				                                    	<div role="group" class="btn-group">
        														    ...
        														    <div aria-labelledby="btnGroupDrop1" class="dropdown-menu">
        														    	<a href="{{ route('edit_categories', $row->id) }}" class="dropdown-item">Edit</a>
        														    	<a href="{{ route('delete_categories', $row->id) }}" class="dropdown-item">Delete</a>
        														    </div>
        														</div>
        													</td>
        				                               	</tr>
