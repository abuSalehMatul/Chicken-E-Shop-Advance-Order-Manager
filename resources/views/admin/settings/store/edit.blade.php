                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <select id="country" name="country" class="form-control multi_select" style="width: 100%">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row last" id="cities_section">
                                                        ...
                                                        <select id="city" name="city" class="form-control multi_select" style="width: 100%">
                                                            @if(!empty($cities))
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group" style="padding : 0.2rem">
                                                            <select class="form-control multi_select" id="status" name="code_1" style="width: 20%">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row last">
                                                        ...
                                                        <div class="input-group" style="padding : 0.2rem">
                                                            <select class="form-control multi_select" id="pages" name="code_2" style="width: 20%">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" id="image1" name="header_image">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row last">
                                                        ...
                                                        <div class="col-md-12">
                                                            <img src="@if(!empty($images_setting->header_image)) {{ asset('public/assets/admin/images/settings/logo/'.$images_setting->header_image) }} @endif" id="preview_image1" alt="Store Header Logo" style="width:150px; height:150px"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" id="image2" name="footer_image">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row last">
                                                        <label class="label-control">Image Preview</label>
                                                        <div class="col-md-12">
                                                            <img src="@if(!empty($images_setting->footer_image)) {{ asset('public/assets/admin/images/settings/logo/'. $images_setting->footer_image) }} @endif" id="preview_image2" alt="Store Header Logo" style="width:150px; height:150px"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" id="image3" name="favicon_image">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row last">
                                                        <label class="label-control">Image Preview</label>
                                                        <div class="col-md-12">
                                                            <img src="@if(!empty($images_setting->favicon_image)) {{ asset('public/assets/admin/images/settings/logo/'.$images_setting->favicon_image) }} @endif" id="preview_image3" alt="Store Favicon Image" style="width:150px; height:150px"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
