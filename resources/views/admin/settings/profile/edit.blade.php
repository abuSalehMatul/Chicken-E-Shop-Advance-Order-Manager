                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group" style="padding : 0.2rem">
                                                            <select class="form-control multi_select" id="code_1" name="code_1" style="width: 20%">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row last">
                                                        ...
                                                        <div class="input-group" style="padding : 0.2rem">
                                                            <select class="form-control multi_select" id="code_2" name="code_2" style="width: 20%">
                                                                @if(!empty($country_code))
                                                                    <option>Select Code</option>
                                                                    @foreach($country_code as $row)
