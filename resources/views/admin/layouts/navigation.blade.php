            ...
            @if(!empty(Session::get('role') == 0))
                <li class="nav-item"><a href="javascript::void(0);"><i class="ft-square"></i><span data-i18n="" class="menu-title">Products</span></a>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="menu-content">
                             <li>
                                <a href="{{ route('allorders') }}"><span data-i18n="" class="menu-title">Orders</span></a>
                            </li>
                            <li>
                                <a href="{{ route('manage_seller_orders') }}"><span data-i18n="" class="menu-title">Manage Orders</span></a>
                            </li>
                            <li>
                                <a href="{{ route('manage_seller_orders') }}"><span data-i18n="" class="menu-title">Orders Details</span></a>
                            </li>
