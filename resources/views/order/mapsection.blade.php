...
<div class="float-left" style="width:21%;" id="map">
    ...
    <div class="pickup-cart" id="pickup-cart" >
         ...
         <h6 style="display:inline">{{$con->quantity}}</h6>
         <h6 style="display:inline">{{$con->name}}</h6>
         <h6 style="display:inline">{{$con->price}}</h6>
         </div>  
         @endforeach
         @endif --}}
    </div>
    ...
    <div class="map-checkout">
        ...
        @endphp
    <a href="#" class="btn btn-info" style="width:100%">Check out<p style="display:inline;margin-left:25px;padding:08px;background:#225f68;color:white">${{$total}}</p></a>
    </div> --}}
</div> 
